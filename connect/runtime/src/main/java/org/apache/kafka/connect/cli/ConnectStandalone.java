...
public class ConnectStandalone {
    ...
    public static void main(String[] args2) {
        // 这里代码必须构建后才能生效
        String[] args = new String[]{"/Users/luobin3/workspace/kafka-2.7.0/config/robin-connect-standalone.properties", "/Users/luobin3/workspace/kafka-2.7.0/config/robin-connect-file-source.properties"};
