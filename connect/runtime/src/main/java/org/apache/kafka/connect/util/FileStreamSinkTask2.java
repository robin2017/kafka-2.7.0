 ...
 */
public class FileStreamSinkTask2 extends SinkTask {
    private static final Logger log = LoggerFactory.getLogger(FileStreamSinkTask2.class);

    private String filename;
    private PrintStream outputStream;

    public FileStreamSinkTask2() {
    }

    // for testing
    public FileStreamSinkTask2(PrintStream outputStream) {
        filename = null;
    ...
    public String version() {
        return new FileStreamSinkConnector2().version();
    }

    @Override
    public void start(Map<String, String> props) {
        filename = props.get(FileStreamSinkConnector2.FILE_CONFIG);
        if (filename == null) {
